...
yargs
  ...
  .command({
    ...
    handler: getSpecificTask,
  })
  .command({
    command: "task-add",
    describe: "add/create a task",
    builder: {
      title: { describe: "title", demandOption: true, type: "String" },
      description: {
        describe: "description",
        demandOption: true,
        type: "String",
      },
      time: { describe: "time/schedule", demandOption: true, type: "String" },
    },
    handler: addtask,
  })
  .command({
  ...
  .command({
    ...
    handler: deleteSpecificTask,
  })
  .command({
    command: "ls-projects",
    describe: "list all the projects",
    builder: { id: { describe: "project name", type: "String" } },
  ...
  .command({
    ...
    builder: {
      name: { describe: "project name", demandOption: true, type: "String" },
    },
    handler: createNewProject,
  })
  .command({
    command: "project-add-task",
    ...
    handler: addProjectTask,
  }).argv;

if (yargs.argv._[0] == undefined) {
  console.log(chalk.yellowBright("\n No command !! Enter the command \n"));
  console.log(chalk.blue("{ --node index.js --help }"));
  console.log(chalk.yellowBright("for relivant commands"));
}
